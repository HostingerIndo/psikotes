...
<div class="container">
            <h1 class="text-right">PT. ADIRA MULTIFINANCE</h1>
            <h3 class="text-right">DAFTAR NILAI PESERTA TES PSIKOTES ONLINE</h3>
            <p class="text-right">JL Insinyur Haji Djuanda, No. 18, Cilembang, Cihideung, Komplek Ruko TFT, Sukamulya, Kec. Bungursari, Tasikmalaya, Jawa Barat 46123  Telp. 0266 5374456 </p>
<hr style="border-block-start-width: 10px;"/>
</div>
<?php 
include '../../config/koneksi.php';
$tampil = mysql_query("SELECT nama,jk,email,benar,salah,kosong,score,keterangan FROM tbl_user INNER JOIN tbl_nilai ON tbl_user.id_user=tbl_nilai.id_user WHERE keterangan='Tidak Lulus'");
echo"
