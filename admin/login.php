  ...
  <head>
    ...
    <!-- <style>
     ...
     <style>
        ...
        body {
    background: #ffc107;
    background: linear-gradient(to right, rgb(40, 167, 69), rgb(255, 190, 80));
  }
    </style>
          ...
          <div class="row mt-5">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
              <div class="card card-signin my-5">
                <div class="card-body">
                  <h5 class="card-title text-center"><img src="../asset/img/1.png" alt="" style="height: 50px;">  APLIKASI PSIKOTES ONLINE</h5>
